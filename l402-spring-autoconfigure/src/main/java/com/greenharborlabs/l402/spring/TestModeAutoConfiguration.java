 ...
 *       (case-insensitive), startup fails immediately — even if an allowed profile is also active.</li>
 *   <li><b>Allowlist (suspenders):</b> at least one of "test", "dev", "local", or "development"
 *       must be active; otherwise startup fails. This catches custom production profile names
 *       like "prd", "live", or "staging" that would bypass the denylist.</li>
 * </ol>
 */
