...
/**
 * TDD tests for {@link L402ActuatorEndpoint}.
 *
 * <p>Verifies the JSON contract defined in l402-http-protocol.md section 7:
 * GET /actuator/l402 must return all required fields including enabled, backend,
 * backendHealthy, testMode, serviceName, protectedEndpoints, credentials, and earnings.
 *
 * <p>The {@code L402ActuatorEndpoint} class does not exist yet (T092).
 * These tests are written first per TDD and will not compile until the endpoint is implemented.
 */
@SpringBootTest(
        classes = L402ActuatorEndpointTest.TestApp.class,
        properties = {
                "management.endpoints.web.exposure.include=l402",
                "l402.enabled=true",
                "l402.backend=lnbits",
                "l402.service-name=my-api",
                "l402.test-mode=false",
                "l402.credential-cache-max-size=10000"
        }
)
@AutoConfigureMockMvc
@DisplayName("L402ActuatorEndpoint")
class L402ActuatorEndpointTest {
     ...
     * The real {@link L402EarningsTracker} class does not exist yet (T093/T094).
     */
    static class StubEarningsTracker extends L402EarningsTracker {
