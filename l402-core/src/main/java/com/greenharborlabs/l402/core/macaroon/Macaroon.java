 ...
 *
 * <p>The identifier is a 66-byte binary blob: {@code [version:2][paymentHash:32][tokenId:32]}.
 * The signature is a 32-byte HMAC-SHA256 digest computed over the identifier and caveat chain.
 * The location is an optional, unsigned hint and plays no role in verification.
 */
public final class Macaroon {
    ...
    public String toString() {
        return "Macaroon[identifierLength=" + identifier.length
                + ", location=" + location
